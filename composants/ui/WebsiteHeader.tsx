...
export default function WebsiteHeader({ website }: WebsiteHeaderType) {
  const { isPinned, toggleWebsitePin } = usePinnedWebsitesStore();
      ...
      <div className="px-6 py-12">
        <header className="text-center pb-12 flex flex-col gap-4">
          ...
          <div className="flex justify-center gap-4">
            <span className="material-symbols-outlined cursor-pointer" onClick={_ => toggleWebsitePin(website)}>{isPinned(website.uid) ? "keep_off" : "keep"}</span>
